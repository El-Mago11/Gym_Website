...
const Home = () => {
  ...
  // Simulate image loading with an effect
  useEffect(() => {
    const images = [assets.image1, assets.image2, assets.image3];
    ...
    <div id='Home' className='home-section overflow-hidden'>
      ...
      >
        <div className='slider-div'>
          ...
          <p className='slider-text text1'>
            Transform your body, mind, and spirit. Start your fitness <br />
            journey with personalized workouts, expert guidance, and a <br />
            community that motivates you every step of the way.
          </p>
          <div className='btns1'>
            <button className='btns'><a href="#Contact">Contact Us</a></button>
            <button className='btns gap-2'><a href="#Contact">Register Now</a></button>
          </div>
        </div>
        ...
        <div>
          ...
          <p className='slider-text text2'>
            Whether you're a beginner or an athlete, we’ve got everything <br />
        ...
        <div>
          ...
          <p className='slider-text text3'>
            Join us today and feel the difference. Build strength, endurance, <br />

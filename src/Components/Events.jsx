  ...
  return (
    <div id='Events' className='bg-black text-white relative bottom-138 '>
       <div className=''>
        ...
        <div className='flex border-b-1 h-55 '>
            <div className=''>
                <img className='w-70 pl-5 mb-5' src={assets.healthwalk1} alt="" />
                  <div className='relative bottom-30 left-60 ml-20'>
            ...
            <h2 className='relative top-23 left-50 font-bold text-4xl'>Health Walk /<span className='text-2xl font-light'>Ayeduase</span></h2>
            <button className='btns h-12 w-19 relative top-23 left-100'>Details</button>
        </div>

        <div className='flex border-b-1 h-55 mt-7'>
            <div className=''>
                <img className='w-70 pl-5 mb-5 ' src={assets.healthwalk1} alt="" />
                  <div className='relative bottom-30 left-60 ml-20'>
            ...
            <h2 className='relative top-23 left-40 font-bold text-4xl'>Weight Lifting Challenge /<span className='text-2xl font-light'>Ayeduase</span></h2>
            <button className='btns h-12 w-35 relative top-23 left-50'>Register Now</button>
            <button className='btns h-12 w-19 relative top-23 left-50'>Details</button>
        </div>
        <div className='flex border-b-1 h-55 mt-7'>
            <div className=''>
                <img className='w-70 pl-5 mb-5' src={assets.healthwalk1} alt="" />
            ...
            <h2 className='relative top-23 left-50 font-bold text-4xl'>Game & Sports /<span className='text-2xl font-light'>Kotei</span></h2>
            <button className='btns h-12 w-35 relative top-23 left-85'>Register Now</button>
            <button className='btns h-12 w-19 relative top-23 left-90'>Details</button>
        </div>
        <div>
            ...
            <p className='pb-6'>Don't miss out on future events! Be sure to check this page regularly for updates or sign up for our newsletter to get event details sent directly to your inbox.</p>
        </div>
    </div>
  )
}

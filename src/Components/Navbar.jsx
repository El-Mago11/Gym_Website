...
const Navbar = () => {
    ...
    <div className='' > 
      <div className='flex flex-row navbar' style={{backgroundColor:colours.black}}>
        ...
        <div className={`nav-links-container ${isOpen ? 'is-open' : ''}`} >
            <ul className='flex flex-row gap-7 text-white pt-6 ml-30 nav-menu ' style={{fontSize:17}} >
                ...
                <li className='nav-links relative'>
                    <a href="#Classes" >
                        Classes         <FontAwesomeIcon icon={faCaretDown} size="" className='ml-1 text-white nav-links' color="black" /></a>
                        <div className='dropdown-menu'>
                             <ul>
                                <li className='sub-links'><a href="#Classes">Classes</a></li>
                                <li className='sub-links'><a href="#Class Schedule">Class Schedule</a></li>
                             </ul>
                        </div>
                </li>
                <li className='nav-links'>
            ...
            <button id='menu-open-button' onClick={toggleMenu} className='menu-toggle'>
                <FontAwesomeIcon  icon={isOpen ? faTimes : faBars} size="" className='ml-55 mt-5 text-white nav-links' color="white"  ></FontAwesomeIcon>
                </button>
        </div>
